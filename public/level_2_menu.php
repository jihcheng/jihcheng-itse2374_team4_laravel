...
?>
    ...
    <label style="color:blue;relative;  top: 6px;">Enter decryption vector
    <a href="#" title="for security reasons when this website go to the internet"><i style="font-size:60%" class="twa twa-2x twa-question-mark"></i></a></label>
    <input id="decryption_iv" size="20" type="password" maxlength="20" name="decryption_iv"/><br>

    <label style="color:blue;relative;  top: 6px;">Enter decryption key
    <a href="#" title="for security reasons when this website go to the internet"><i style="font-size:60%" class="twa twa-2x twa-question-mark"></i></a></label>
    <input id="decryption_key" size="20" type="password" maxlength="20" name="decryption_key"/><br>
...
?>
    <fieldset style="position: relative;  top: -8px ;left:4px; font-size:85%;"><legend><?php echo str_replace("_"," ",$level_1_menu);?></legend>
    <label style="color:blue;relative;  top: 6px;">Enter Your email
    <a href="#" title="Enter email address you registed for this website"><i style="font-size:60%" class="twa twa-2x twa-question-mark"></i></a>
    </label><br>
    <input id="user_email" size="30" type="email" maxlength="30" name="user_email"/><br>

    <label style="color:blue;relative;  top: 6px;">Enter Your Password</label>
    <input id="user_password" size="20" type="password" maxlength="20" name="user_password"/><br>
...
?>
        ...
        <button id="find_group_dropdown" type="button" onclick="group_message_next(this.value)" style="position: relative;  top: 5px ; background:#00FEC4; color:black">Next Step</button>
